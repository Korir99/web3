...
L.tileLayer('https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=48q75muHRgW2xeDZPOr5', {
        ...
        markerColor: 'red', //Possible: red, darkred, orange, green, darkgreen, blue, purple, dark purple
        ...
        function onEachFeature(feature, layer) {
            if (feature.properties.grades) {
              var popupcontent;
              popupcontent = "<span style='font-weight:normal'>Restaurant Name: </span>" + feature.properties.name + "<br>" + "<span style='font-weight:bold'>Cuisine: </span>" + feature.properties.cuisine + "<br>" + "<span style='font-weight:bold'>Street: </span>" + feature.properties.street;
              for (i = 0; i < feature.properties.grades.length; i = i + 1) {
                var dateString = "<br> <span style='font-weight:normal'> Date: </span>" + feature.properties.grades[i].date.$date;
